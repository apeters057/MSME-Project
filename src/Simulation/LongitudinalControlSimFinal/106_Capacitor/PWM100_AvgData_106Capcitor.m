...
baseFileName = '106_UnitStep_PWM100_Test';
...
title('Avg Motor Voltage @ 100% PWM  (10 uF)', 'FontWeight', 'bold');
xlabel('Avg Time [s]')
ylabel('Avg Voltage [V]')
subplot(2, 1, 2);
plot(t_average,accelX_driving_average)
title('Avg. Foward Car Acceleration @ 100% PWM  (10 uF)', 'FontWeight', 'bold');
xlabel('Avg. Time [s]')
