...
title('Avg Motor Voltage @ 90% PWM  (10 uF)', 'FontWeight', 'bold');
xlabel('Avg Time [s]')
ylabel('Avg Voltage [V]')
subplot(2, 1, 2);
plot(t_average,accelX_driving_average)
title('Avg. Foward Car Acceleration @ 90% PWM  (10 uF)', 'FontWeight', 'bold');
xlabel('Avg. Time [s]')
